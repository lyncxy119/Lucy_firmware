...
NPI_PrintString("SimpleBLETest_Init2\r\n");      
    */
#if 0
// ¿ÉÒÔÊä³öÒ»¸öÖµ£¬ÓÃ10½øÖÆ±íÊ¾    
NPI_PrintValue("ÌðÌðµÄ´óÏã¹Ï1 = ", 168, 10);    
NPI_PrintString("\r\n");      
    
// ¿ÉÒÔÊä³öÒ»¸öÖµ£¬ÓÃ16½øÖÆ±íÊ¾    
NPI_PrintValue("ÌðÌðµÄ´óÏã¹Ï2 = 0x", 0x88, 16);    
NPI_PrintString("\r\n");   
#endif
}
 ...
 * @fn      Á¬½ÓÀ¶ÑÀ
 *
 * @brief   Á¬½ÓÖ¸¶¨macµØÖ·µÄÀ¶ÑÀÉè±¸
 * @param   macAddr   macµØÖ·    
 *
 * @return  none
/**********************************************************************/
         ...
         //       HalUARTWrite( NPI_UART_PORT, buffer, numBytes);
             ...
             //   NPI_PrintString("\r\n");
              ...
              //    calc_data_send(macAddr,6,0x85);
                ...
                //  NPI_PrintValue("connecting Mac %d",1,18);
                            ...
                            if(rxlen == rxLEN)
                            {
                               ...
                               if(checksum == checksum_byte)
                               {
                                ...
                                case CONNECT_REQ://Á¬½ÓÀ¶ÑÀ
                                  ...
                                  break;
                                case DISCONNECT_REQ://¶Ï¿ªÀ¶ÑÀÁ¬½Ó
